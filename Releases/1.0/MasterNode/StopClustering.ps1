...
for ($j=0;$j -lt $workernodes.length;$j++) {
	...
	iex "& '$prc' http://$workernode Administrator password 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe' 'Stop-Process -ProcessName TitanSpikeClusterer' C:\Titanic\Clusterer"
}
